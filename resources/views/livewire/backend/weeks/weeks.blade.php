                                ...
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <span wire:click="sortBy('end')" class="text-sm float-sm-right"
                                            style="cursor: pointer;font-size:10px;">
                                            <i class="mr-1 fa fa-arrow-up"
                                                style="color:{{ $sortColumnName === 'end' && $sortDirection === 'asc' ? '#90EE90' : '' }}"></i>
                                            <i class="fa fa-arrow-down"
                                                style="color : {{ $sortColumnName === 'end' && $sortDirection === 'desc' ? '#90EE90' : '' }}"></i>
                                        </span>
                                    </th>
                                    <th>
                                        @lang('site.semester')
                                        <span wire:click="sortBy('semester_id')" class="text-sm float-sm-right"
                                            style="cursor: pointer;font-size:10px;">
                                            <i class="mr-1 fa fa-arrow-up"
                                                style="color:{{ $sortColumnName === 'semester_id' && $sortDirection === 'asc' ? '#90EE90' : '' }}"></i>
                                            <i class="fa fa-arrow-down"
                                                style="color : {{ $sortColumnName === 'semester_id' && $sortDirection === 'desc' ? '#90EE90' : '' }}"></i>
                                        </span>
                                    </th>
                                    <th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check">
                                            <input wire:change="changeActive({{ $week->id }})" class="form-check-input"
                                                type="checkbox" {{ $week->active ? 'checked' : '' }} {{
                                            auth()->user()->roles[0]->name == 'superadmin' ? '' : 'disabled' }}>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <button wire:click.prevent="edit({{ $week }})"
                                                class="btn btn-primary btn-sm" {{ auth()->user()->roles[0]->name ==
                                                'superadmin' ? '' : 'disabled' }}><i class="fa fa-edit"></i></button>
                                            @if (auth()->user()->roles[0]->name == 'superadmin')
                                            <button wire:click.prevent="confirmWeekRemoval({{ $week->id }})"
                                                class="btn btn-danger btn-sm" {{ auth()->user()->roles[0]->name ==
                                                'superadmin' ? '' : 'disabled' }}><i
                                        ...
                                        {{-- <form action="" method="post" id="delete-week-{{ $week->id }}"
                                            class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form> --}}
