                    ...
                    <div class="table-responsive">
                        <table id="example2" class="table text-center table-bordered table-hover dataTable dtr-inline"
                            ...
                            <thead class="bg-light">
                                <tr wire:ignore.self>
                                    <th><button type="button" class="btn btn-sm btn-secondary" data-toggle="collapse"
                                            data-target=".ShowHide">#</button></th>
                                    <th>Name</th>
                            ...
                            <tbody>
                                ...
                                <tr style="background-color: rgb(218, 252, 220)">
                                    <td><button type="button" class="btn btn-sm btn-light" data-toggle="collapse"
                                            aria-expanded="true" data-target="#collapseme{{$user->id}}">{{
                                            $loop->iteration }}</button></td>
                                            ...
                                            <table id="example2"
                                                ...
                                                <tbody class="text-center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ Alkoumi\LaravelHijriDate\Hijri::Date('l', $event->start)
                                                            }}<br>
                                                            {{ Alkoumi\LaravelHijriDate\Hijri::Date('Y-m-d',
                                                            $event->start) }}<br>
                                                        ...
                                                        <td>{{ $event->week->title . ' (' .
                                                            $event->week->semester->school_year . ' )' }}</td>
                                                        <td>
                                                            <span
